...
##云端启动
# gcloud run deploy test1-container --image us-central1-docker.pkg.dev/civil-zodiac-422613-b7/cloud-run-source-deploy/test_1:latest --memory 1Gi --port 8081  --region us-central1 
# gcloud run deploy test-container --image us-central1-docker.pkg.dev/civil-zodiac-422613-b7/cloud-run-source-deploy/test:latest
