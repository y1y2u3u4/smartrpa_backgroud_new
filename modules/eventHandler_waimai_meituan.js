...
export async function handleEvent(event, page, browser, index, sortedData_new, task_name, cityname, user_id) {
    ...
    switch (event.type) {
        case 'click':
            task = new ClickTask(event.element, browser, task_name, cityname, user_id);
            break;
        case 'input':
